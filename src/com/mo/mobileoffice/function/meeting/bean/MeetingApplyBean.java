...
public class MeetingApplyBean implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8542071670433706554L;
	...
	public String toString() {
		return "MeetingApplyBean [user_name=" + user_name + ", id=" + id
