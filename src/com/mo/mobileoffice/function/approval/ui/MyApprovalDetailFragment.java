...
public class MyApprovalDetailFragment extends
	...
	private LinearLayout already_app;
	...
	protected void init() {
		if (data.getApp_type().equals("1")) {
			...
			already_app=findViewById(R.id.already_app);
	...
	public void onResume() {
		...
		if (data.getApp_type().equals("1")) {
			...
			app_Type.setText(data.getApp_type());
			...
			if(data.getState().equals("0")){
				already_app.setVisibility(View.GONE);
			}else{
					...
					imageView.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							if (list.size() > 0) {
								...
								bundle.putInt("imageId",Integer.parseInt((String)v.getTag()));
								openIdeaActivity(
